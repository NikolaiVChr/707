RWRCanvas = {
    new: func (_ident, root, center, diameter) {
        ...
        rwr.max_icons = 16;# Page 209 of MLU tape 1
...
cv.addPlacement({"node": "canvasRWR", "texture":"radarblade.png"});
...
var timer = maketimer(0.5, func rwr.update(radar_system.f16_rwr.vector_aicontacts_threats, "normal"););
timer.start();